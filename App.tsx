          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="text-center md:text-left">
              ...
              <p className="text-sm md:text-lg text-gray-600">
                विषय: विकसित आणि आत्मनिर्भर भारतासाठी | उपविषय: उदयोन्मुख तंत्रज्ञान
              </p>
            </div>
      ...
      <main className="flex-grow container mx-auto px-4 py-8 max-w-6xl space-y-12">
        ...
        <section className="bg-white rounded-xl p-6 md:p-8 shadow-sm border border-gray-100">
          ...
          <p className="text-gray-700 leading-relaxed text-lg">
            ...
            हे यंत्र कमी खर्चात तापमान, आर्द्रता, हवेचा वेग आणि जमिनीतील ओलावा मोजते आणि 'उदयोन्मुख तंत्रज्ञान' या संकल्पनेवर आधारित आहे.
          </p>
        </section>
